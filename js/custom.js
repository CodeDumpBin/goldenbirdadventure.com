...
var winWidth;
		...
		$(function(){
			...
			$('.showOverlay1').on('click',function(){
				$('.blackOverlay1').show();
				var getHeight = $('.blackOverlay1').find('.overlayForm').height();
				console.log(getHeight);
				$('.overlayBoxF').css({'height':getHeight+20});
			});
			$('.overlayClose, .blackOverlay1').on('click',function(){
				$('.blackOverlay1').hide();
			});
			...
			$('.showOverlay2').on('click',function(){
				$('.blackOverlay2').show();
			});
			$('.overlayClose, .blackOverlay2').on('click',function(){
				$('.blackOverlay2').hide();
			});
			$(document).bind('keydown', function(e) { 
				if (e.which == 27) {
			...
			wResize();	
			$('.showOverlay3').on('click',function(){
				$('.blackOverlay3').show();
			});
			$('.overlayClose, .blackOverlay3').on('click',function(){
				$('.blackOverlay3').hide();
			});
			$(document).bind('keydown', function(e) { 
				if (e.which == 27) {
			...
			$('.showOverlay4').on('click',function(){
 			 $('.blackOverlay4').show();
     imgUrl = $(this).attr('src');
    laggeImg = imgUrl.slice(0, -4)+'_big.jpg';
    $('.overlayImage img').attr('src',laggeImg);
				var getHeight = $('.blackOverlay4').find('.overlayImage').height();
				console.log(getHeight);
				$('.blackOverlay4').find('.overlayBox').css({'height':getHeight});
	
 });
 $('.overlayClose, .blackOverlay4').on('click',function(){
  $('.blackOverlay4').hide();
 });
 $(document).bind('keydown', function(e) { 
				if (e.which == 27) {
 ...
 $('.overlay-button').on('click',function(){
  $('.blackOverlay4').show();
    var getUrl = $(this).closest('.overlay-parent').find('.showOverlay').attr('src');
...
/*
------------------------------------------------------------
slide the sidebar form (open form)
------------------------------------------------------------
*/
function slideIt() {
...
/*
------------------------------------------------------------
form button to close the slider.
------------------------------------------------------------
*/
...
/*autoheight*/
	...
	$('.box1').each(function() {
        var getHeight= $(this).height();
		AllHeights.push(getHeight);
		/*console.log(AllHeights);*/
    });
	maxValue = Math.max.apply(this, AllHeights);
	$('.box1').css({height:maxValue});
});
